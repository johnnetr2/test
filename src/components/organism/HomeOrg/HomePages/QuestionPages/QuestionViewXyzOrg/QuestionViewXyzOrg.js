    ...
    <div>
      ...
      >
        <Toolbar>
          <Typography
            variant="body1"
            style={{ width: 1200, marginLeft: "10rem" }}
                    ...
                    {quiz &&
                      quiz.map((item, index) => {
                        return (
                          <Box
                            sx={{
                              backgroundColor: exitsIndex(index)
                                ? "#6fcf97"
                                : "#B4B4B4",
                              marginLeft: "2px",
                              flex: "1",
                  ...
                  >
                    <Box sx={{ width: 500, display: "flex" }}>
                      <Box>
                        ...
                        >
                          Vi ser att den lite tjockare solida linjen
                          representerar dike och vi hittar en sådan linje att
                          följa i området Byängen.
                        </Typography>
                        <Typography
                          variant="body1"
                          component="div"
                        ...
                        >
                          Från vänster till höger ser vi att streckets riktning
                          lutar nedåt. Det betyder alltså att från väst till öst
                          går diket från nord till syd, eller uttryckt i andra
                          ord går diket från nordväst till sydost.
                        </Typography>
                      </Box>
                      <Box mt={2}>
