...
const Quan_Comp_N_Org = () => {

    return (
        <div className="quan-n-container-1">
            <div className="quan-n-content-1">
                <div className="quan-n-content-1-3">
                    <h3>Kvantitativa jämförelser - NOG</h3>
                </div>
                <div className="quan-n-nav-item-1-2">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidi...</p>
                </div>
                <div className="quan-n-head-1-2">
                    <h3>Övningsuppgifter för NOG</h3>
                    <div className="quan-n-head-1-3">
                        <div className="quan-n-head-1-4">
                            <p>Välj om du vill köra på tid</p>
                            <Outline_Field title="Tidspress" type="checkbox" />
                        </div>
                        <div className="quan-n-head-1-5">
                            <p>Välj antal frågor</p>
                            <div className="quan-n-head-outline-boxes">
                                <Outline_Box title="5" />
                ...
                <div className="quan-n-question-type">
                    <p>Välj frågetyper</p>
                    <div className="question-n-type-1">
                ...
                <div className="exer-n-btn-2">
                    <Link to="/question-view-nog"><Exercise_Btn title="Starta övningar" /></Link>
                </div>
                <div className="history-n">
                    <h2>Historia</h2>
                    <table>
                        <thead>
                            <tr>
            ...
            <div className="quan-n-rt-sidebar-container-1">
                <div className="quan-n-rt-sidebar-1">
                    <h3>Statistik</h3>
                    <p>Du har klarat 830 av 1000 uppgifter</p>
                    <div className="quan-n-box-1">
                        <div className="quan-n-inner-box-1">
                            <div className="quan-n-progress-bar">
                                <p>12 av 100</p>
                            </div>
                        </div>
                    </div>
                    <div className="quan-n-graph-box-1-3">
                        <div className="quan-n-task">
                            <div className="quan-n-task-1">
                                <h3>4</h3>
                                <p>Gjorda uppgifter förra veckan</p>
                            </div>
                            <div className="quan-n-task-2">
                                <h3>830</h3>
                                <p>Gjorda uppgifter totalt</p>
                            </div>
                        </div>
                        <div className="quan-n-inner-box-1-3">
                            <img src={Graph_2} alt="" />
                        </div>
                        <div className="quan-n-score-1">
                            <h3>0.8</h3>
                            <p>Gjorda uppgifter totalt</p>
                        </div>
                        <div className="quan-n-inner-box-1-3">
...
export default Quan_Comp_N_Org
