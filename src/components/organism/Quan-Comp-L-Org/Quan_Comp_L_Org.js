...
const Quan_Comp_L_Org = () => {

    return (
        <div className="quan-l-container-1">
            <div className="quan-l-content-1">
                <div className="quan-l-content-1-3">
                    <h3>Kvantitativa jämförelser - LÄS</h3>
                </div>
                <div className="quan-l-nav-item-1-2">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidi...</p>
                </div>
                <div className="quan-l-head-1-2">
                    <h3>Övningsuppgifter för LÄS</h3>
                    <div className="quan-l-head-1-3">
                        <div className="quan-l-head-1-4">
                            <p>Välj om du vill köra på tid</p>
                            <Outline_Field title="Tidspress" type="checkbox" />
                        </div>
                        <div className="quan-l-head-1-5">
                            <p>Välj antal frågor</p>
                            <div className="quan-l-head-outline-boxes">
                                <Outline_Box title="5" />
                ...
                <div className="quan-l-question-type">
                    <p>Välj frågetyper</p>
                    <div className="question-l-type-1">
                ...
                <div className="exer-l-btn-2">
                    <Link to='/question-view-las'><Exercise_Btn title="Starta övningar" /></Link>
                </div>
            ...
            <div className="quan-l-rt-sidebar-container-1">
                <div className="quan-l-rt-sidebar-1">
                    <h3>Statistik</h3>
                    <p>Du har klarat 830 av 1000 uppgifter</p>
                    <div className="quan-l-box-1">
                        <div className="quan-l-inner-box-1">
                            <div className="quan-l-progress-bar">
                                <p>12 av 100</p>
                            </div>
                        </div>
                    </div>
                    <div className="quan-l-graph-box-1-3">
                        <div className="quan-l-task">
                            <div className="quan-l-task-1">
                                <h3>4</h3>
                                <p>Gjorda uppgifter förra veckan</p>
                            </div>
                            <div className="quan-l-task-2">
                                <h3>830</h3>
...
export default Quan_Comp_L_Org
